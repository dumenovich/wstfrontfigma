...
export default function VariantB({ email, setEmail, isSubscribed, handleSubscribe }: VariantBProps) {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: "Отчеты о рисках спасли меня от покупки проблемного участка. Сэкономила время и деньги.",
      rating: 5
    },
    {
      name: "Дмитрий П.",
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="mb-12 text-white/60 text-xl max-w-3xl mx-auto">
              Автоматический мониторинг торгов, анализ рисков и умные уведомления — всё в одной платформе
            </p>
            ...
            <div className="flex items-center justify-center gap-12 flex-wrap">
              <div>
                ...
                <div className="text-white/50">Участков в базе</div>
              </div>
              <div>
                <div className="text-white text-4xl mb-1">24/7</div>
                <div className="text-white/50">Мониторинг торгов</div>
              </div>
              <div>
                <div className="text-white text-4xl mb-1">85%</div>
                <div className="text-white/50">Экономия времени</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="mb-4 text-white">Что вы получите</h2>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-6">
              <Card className="group relative bg-white/5 backdrop-blur-[4px] p-6 transition-all overflow-hidden rounded-2xl border border-white/10 shadow-lg hover:shadow-2xl hover:border-[#4D9999]/50 hover:bg-white/10">
                <div className="relative mb-4">
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gradient-to-r from-[#267373] to-[#4D9999] text-white rounded-full shadow-lg shadow-cyan-500/20">
                    <span>Сейчас</span>
                  </div>
                </div>
                <div className="relative">
                  <p className="text-white/70 leading-relaxed">
                    Получите гайд <span className="text-[#66B2B2]">«7 скрытых рисков при покупке земли на торгах»</span> — сразу на почту
                  </p>
                </div>
              </Card>

              <Card className="group relative bg-white/5 backdrop-blur-[4px] p-6 transition-all overflow-hidden rounded-2xl border border-white/10 shadow-lg hover:shadow-2xl hover:border-[#A78BFA]/50 hover:bg-white/10">
                <div className="relative mb-4">
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gradient-to-r from-[#A78BFA] to-[#9333EA] text-white rounded-full shadow-lg shadow-purple-500/20">
              ...
              <Card className="group relative bg-white/5 backdrop-blur-[4px] p-6 transition-all overflow-hidden rounded-2xl border border-white/10 shadow-lg hover:shadow-2xl hover:border-[#66B2B2]/50 hover:bg-white/10">
                <div className="relative mb-4">
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-gradient-to-r from-[#4D9999] to-[#66B2B2] text-white rounded-full shadow-lg shadow-teal-500/20">
                    <span>Эксклюзив</span>
                  </div>
                </div>
                <div className="relative">
