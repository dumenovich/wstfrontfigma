      ...
      <article className="max-w-4xl mx-auto px-6 py-12 print:py-0">
        ...
        <section className="mb-12 print:mb-8">
          ...
          <div className="space-y-4 text-slate-700 leading-relaxed">
            ...
            <p>
              Мы проанализировали более 12 000 лотов на торгах
        ...
        <section className="mb-12 print:mb-8 print:page-break-before">
          ...
          <div className="mb-6 print:break-inside-avoid">
            ...
            <ul className="space-y-1.5 text-slate-700 ml-4">
              ...
              <li>
                • Требование снести уже возведённые постройки
              </li>
          ...
          <div className="bg-slate-50 rounded-lg p-6 print:break-inside-avoid">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="space-y-1 text-slate-600 ml-4 text-sm">
                  <li>
                    • Закажите в местной администрации или через
                    Госуслуги
                  </li>
              ...
              <div>
                ...
                <ul className="space-y-1 text-slate-600 ml-4 text-sm">
                  ...
                  <li>
                    • В разделе 4 указаны зарегистрированные
                    ограничения
                  </li>
                  <li>
                    • Стоимость: 350–870 ₽, срок: 3–5 рабочих
                    дней
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-1 text-slate-600 ml-4 text-sm">
                  <li>
                    • Обратитесь в местное отделение «Газпром
                    газораспределение»
                  </li>
                  <li>
                    • Направьте запрос в сетевую организацию
                    (МРСК, Россети)
                  </li>
                </ul>
              </div>
        ...
        <section className="mb-12 print:mb-8 print:page-break-before">
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 print:break-inside-avoid">
            ...
            <div>
              ...
              <ul className="space-y-1 text-slate-700 ml-4 text-sm">
                ...
                <li>
                  • ЛПХ (личное подсобное хозяйство) — только в
                  границах населённого пункта
                </li>
          ...
          <div className="mb-6 print:break-inside-avoid">
            ...
            <ul className="space-y-1.5 text-slate-700 ml-4">
              ...
              <li>
                • Изменение ВРИ стоит от 50 000 до 500 000 ₽ и
                занимает 3–12 месяцев
              </li>
          ...
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 print:break-inside-avoid">
            ...
            <div className="overflow-x-auto">
              ...
              <p className="text-xs text-slate-600 mt-2">
                *550 ₽ — льготный тариф, если ЛЭП в пределах 300
                м. Если дальше — за каждый метр платите вы.
              </p>
            </div>
          </div>
          ...
          <div className="bg-slate-50 rounded-lg p-6 print:break-inside-avoid">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <ul className="space-y-1 text-slate-600 ml-4 text-sm">
                  <li>
                    • Обратитесь в местный Горгаз / «Газпром
                    газораспределение»
                  </li>
                  <li>
